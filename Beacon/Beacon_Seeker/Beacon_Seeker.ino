...
#define BlueLED 6;
#define YellowLED 8;
#define RedLED 14;  //might need to be A0. A0 and 14 are the same pin just not sure which the compiler will like more.
...
float radius = 30.0;
float previous_distance = -1;    //used for hide and seek states
...
uint8_t range_decoder(float distance){
  uint8_t state;
...
void seeker_output(uint8_t new_state){
